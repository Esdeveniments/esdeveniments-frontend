...
import { DEFAULT_LOCALE, SUPPORTED_LOCALES, type AppLocale } from "types/i18n";
...
export async function generateStaticParams() {
  ...
  return topStaticGenerationPlaces.flatMap((slug) =>
    SUPPORTED_LOCALES.map((locale) => ({ locale, place: slug }))
  );
}
...
export async function generateMetadata({
  ...
  params: Promise<PlaceStaticPathParams & { locale: AppLocale }>;
}) {
