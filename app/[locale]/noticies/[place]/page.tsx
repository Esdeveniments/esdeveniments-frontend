...
export async function generateMetadata({
  ...
  params: Promise<{ locale: AppLocale; place: string }>;
}): Promise<Metadata> {
  ...
  const base = buildPageMeta({
    ...
    canonical: toLocalizedUrl(`/noticies/${place}`, locale),
    locale,
  ...
  return {
    ...
    alternates: {
      ...
      types: {
        ...
        "application/rss+xml": [
          {
            url: withLocalePath(`/noticies/${place}/rss.xml`, locale),
