          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-element-gap mb-element-gap">
            ...
            >
              <PressableAnchor
                ...
                className="body-small text-primary hover:underline hover:text-primary-dark transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-xs"
                prefetch={false}
                variant="inline"
              >
