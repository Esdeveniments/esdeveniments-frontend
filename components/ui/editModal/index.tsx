        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-center py-4">
            <button
              ...
              className="disabled:opacity-50 disabled:cursor-default disabled:hover:bg-primary text-background bg-primary rounded-xl py-3 px-6 ease-in-out duration-300 border border-background focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 font-barlow uppercase font-semibold tracking-wide"
            >
              {t("submit")}
            </button>
          </div>
