...
export default async function ServerNavLink({
  href,
  children,
  className = "flex justify-center items-center gap-component-xs text-blackCorp bg-whiteCorp py-component-xs px-component-sm font-barlow italic uppercase font-medium tracking-wider ease-in-out duration-200",
  activeLinkClass,
}: ServerNavLinkProps) {
