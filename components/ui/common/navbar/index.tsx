...
export default function Navbar() {
	...
	useEffect(() => {
		...
		window.addEventListener("focus", check as any);
		return () => {
	...
	return (
		<Disclosure key={pathname} as="nav" className="w-full bg-whiteCorp relative top-0 z-10">
			{({ open }) => (
				<>
						...
						<div className="h-full flex flex-col justify-center">
							...
							<div className="flex justify-around items-center">
								...
								<div className="md:w-1/2 flex justify-end items-center">
									<div className="hidden md:flex md:items-center gap-x-4">
										{navigation.map((item) => (
											<ActiveLink href={item.href} key={item.name} className="border-b-2 border-b-whiteCorp">
												{item.name}
											</ActiveLink>
										))}
										<ActiveLink href={isLogged ? "/dashboard" : "/auth/login"} className="border-b-2 border-b-whiteCorp">
							...
							<div className="fixed h-content bottom-0 left-0 right-0 py-2 bg-whiteCorp flex justify-evenly items-center gap-16 md:hidden">
								...
								<div className="flex justify-center items-center rounded-xl cursor-pointer">
									<ActiveLink href="/">
										<button type="button" className="flex items-center p-2 border-b-whiteCorp focus:outline-none cursor-pointer rounded-xl" aria-label="Home">
								...
								<div className="flex justify-center items-center rounded-xl cursor-pointer">
									<ActiveLink href="/publica">
										<button type="button" className="flex items-center p-2 border-b-whiteCorp focus:outline-none cursor-pointer rounded-xl" aria-label="Publish">
								...
								<div className="flex justify-center items-center rounded-xl cursor-pointer">
									<ActiveLink href="/qui-som">
										<button type="button" className="flex items-center p-2 border-b-whiteCorp focus:outline-none cursor-pointer rounded-xl" aria-label="WhoAreWe">
								...
								<div className="flex justify-center items-center rounded-xl cursor-pointer">
									<ActiveLink href={isLogged ? "/dashboard" : "/auth/login"}>
										<button type="button" className="flex items-center p-2 border-b-whiteCorp focus:outline-none cursor-pointer rounded-xl" aria-label="Compte">
