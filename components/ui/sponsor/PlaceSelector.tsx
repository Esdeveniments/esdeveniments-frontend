          ...
          <div className="relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-input border border-border bg-background focus:outline-hidden focus:ring-2 focus:ring-primary/20 focus:border-primary"
