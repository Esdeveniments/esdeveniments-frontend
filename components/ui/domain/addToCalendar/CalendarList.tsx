...
const CalendarList: FC<CalendarListProps> = ({ onClick, getUrls, title }) => {
  ...
  const linkClass = "block mb-component-lg last:mb-xs hover:underline";
  ...
  return (
    <div className="absolute left-0 top-full z-10 mt-component-xs bg-whiteCorp">
      <div className="animate-appear rounded-md border border-bColor p-component-md shadow-md">
        {calendarOptions.map(
          (option) =>
            option.url && (
              <a
