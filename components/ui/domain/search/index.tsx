...
export default function Search(): JSX.Element {
  ...
  return (
    <div
      className="mt-component-xs flex w-full justify-center rounded-full border border-bColor border-opacity-50 px-component-md"
      data-testid="search-bar"
    >
      <div className="flex w-full items-center justify-start gap-component-xs rounded-full">
        <div className="flex h-10 cursor-pointer items-center justify-end">
          <SearchIcon
        ...
        <input
          type="text"
          className="w-full rounded-br-full rounded-tr-full border-0 text-[16px] placeholder:text-bColor"
