  ...
  return (
    <div className="flex flex-col items-center justify-center mt-8">
      <button
        ...
        className="bg-primary hover:bg-primary/90 text-white text-lg font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 max-w-full text-center"
      >
