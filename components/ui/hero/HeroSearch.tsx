    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="w-full max-w-2xl mx-auto relative">
        <div className="relative group">
          ...
          <input
            type="text"
            className="w-full pl-11 pr-12 py-3 bg-background border border-border rounded-full shadow-xs hover:shadow-md focus:shadow-md focus:border-primary focus:ring-1 focus:ring-primary transition-all outline-hidden text-base placeholder:text-foreground/40"
